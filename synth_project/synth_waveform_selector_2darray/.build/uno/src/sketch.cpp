...
void loop(){
  ...
  if((index+phase)>=LENGTH) index-=phase;
  if(index==(LENGTH+phase)) TIMSK1 = (0<<OCIE1A);//index=0;
  
  //--- crude normalization ---
  //val = wave[waveform][index]+val2;
  //if(val>63)val=63;
